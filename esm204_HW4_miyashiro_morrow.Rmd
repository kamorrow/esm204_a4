...
```{r}
# Keene's check of the above
# 10% change in T is the same, but the others are off between the two calcs (see L_diff).
# Did you remember to reduce T back to 4.4 for the other calcs?
...
df_2b <- data.frame(increase = c("none", "T", "g", "eta", "beta")) %>%
  ...
  mutate(L_KM = c(sen(df_2b$T_sen[1], df_2b$g_sen[1], df_2b$eta_sen[1], df_2b$beta_sen[1], delta),
               sen(df_2b$T_sen[2], df_2b$g_sen[2], df_2b$eta_sen[2], df_2b$beta_sen[2], delta),
               sen(df_2b$T_sen[3], df_2b$g_sen[3], df_2b$eta_sen[3], df_2b$beta_sen[3], delta),
               sen(df_2b$T_sen[4], df_2b$g_sen[4], df_2b$eta_sen[4], df_2b$beta_sen[4], delta),
               sen(df_2b$T_sen[5], df_2b$g_sen[5], df_2b$eta_sen[5], df_2b$beta_sen[5], delta))) %>%
